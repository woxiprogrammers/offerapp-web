...
@section('title','OfferApp | Edit Seller')
@section('css')
                ...
                <div class="col-md-8">
                    ...
                    <div class="portlet light bordered">
                        ...
                        <div class="portlet-body">
                            <form class="profile-form" action="{{ route('setSellerEdit',['seller_id' => $seller_id]) }}" method="post" enctype="multipart/form-data" role="form">
                                {{ csrf_field() }}
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane active" id="tab_1_1 ">
                                        ...
                                        <div class="form-group{{ $errors->has('first_name') ? ' has-error' : '' }}" id="first_name">
                                            ...
                                            <div class="input-icon">
                                                ...
                                                <input class="form-control placeholder-no-fix" type="text" placeholder="First Name"
                                                       value="{{$sellerAddress->seller->user->first_name}}" name="first_name">
                                        ...
                                        <div class="form-group{{ $errors->has("last_name") ? ' has-error' : '' }}" id="last_name">
                                            ...
                                            <div class="input-icon">
                                                ...
                                                <input class="form-control placeholder-no-fix" type="text" placeholder="Last Name"
                                                       value="{{$sellerAddress->seller->user->last_name}}" name="last_name"  />
                                        ...
                                        <div class="form-group{{ $errors->has("shop_name") ? ' has-error' : '' }}" id="shop_name">
                                            <label >Shop Name</label>
                                            <div class="input-icon">
                                                <i class="icon-basket"></i>
                                                <input class="form-control placeholder-no-fix" type="text" placeholder="Shop Name"
                                                       value="{{$sellerAddress->shop_name}}" name="shop_name"  />
                                                @if ($errors->has("last_shop"))
                                                    <span class="help-block alert-danger">
                                        ...
                                        <div class="form-group{{ $errors->has('mobile_no') ? ' has-error' : '' }}" id="mobile_no">
                                            ...
                                            <div class="input-icon">
                                                ...
                                                <input class="form-control placeholder-no-fix" type="text" placeholder="+91 1234567890"
                                                       value="{{$sellerAddress->seller->user->mobile_no}}" name="mobile_no"  />
                                        ...
                                        <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}" id="email">
                                            ...
                                            <div class="input-icon">
                                                ...
                                                <input class="form-control placeholder-no-fix" type="text" placeholder="http://www.myemail.com"
                                                       value="{{$sellerAddress->seller->user->email}}" name="email"  />
                                                @if ($errors->has('email'))
                                                    <span class="help-block alert-danger">
