    ...
    @foreach($members as $member)
        <div class="mt-action">
            <div class="mt-action-img">
                <img src="{{($member->profile_picture == null) ? '/uploads/user_profile_male.jpg' : env('WEB_PUBLIC_PATH').env('CUSTOMER_PROFILE_IMAGE_UPLOAD').DIRECTORY_SEPARATOR.$member->id.DIRECTORY_SEPARATOR.$member->profile_picture}}" /> </div>
