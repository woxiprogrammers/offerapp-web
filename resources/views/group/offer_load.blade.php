        ...
        <div class="mt-action">
            <div class="mt-action-body">
                <div class="mt-action-row">
                    <div >
                        <img class="img-thumbnail" src="{{($offer['offerImage'] == null) ? '/uploads/no_image.jpg' : env('OFFER_IMAGE_UPLOAD').DIRECTORY_SEPARATOR.sha1($offer['offer_id']).DIRECTORY_SEPARATOR.$offer['offerImage']}}" />
                    </div>
